...
public class NaturalKeyPartitioner implements
		Partitioner<DiagnosisKey, DiagnosisDataPoint> {

	@Override
	public int getPartition(DiagnosisKey key, DiagnosisDataPoint value,
			int numPartitions) {
		return Math.abs(key.getDiagnosis().hashCode() * 127) % numPartitions;
	}
