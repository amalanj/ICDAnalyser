...
@Record
public class NHDSFileReader2010 {
	...
	public String getAdmittingDiag() {
		return admittingDiag;
	}
	...
	public void setAdmittingDiag(String admittingDiag) {
		this.admittingDiag = admittingDiag;
	}
